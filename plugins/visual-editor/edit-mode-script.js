const CONFIG_URL = '/plugins/visual-editor/visual-editor-config.js';
let POPUP_STYLES = '';
let getPopupHTMLTemplate = () => '';

// Load config dynamically
(async () => {
  try {
    const module = await import(CONFIG_URL);
    POPUP_STYLES = module.POPUP_STYLES;
    getPopupHTMLTemplate = module.getPopupHTMLTemplate;
  } catch (error) {
